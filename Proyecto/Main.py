...
def crear_gui():
    ...
    ## Title
    titulo_label = Label(frame, bg="#F8F9FA", fg="#2C3E50", font=("Arial", 22, "bold"), text="Algoritmo PSO")
    ...
    subtitulo1_label1 = Label(frame1, bg="#FFFFFF", fg="#495057", font=("Arial", 12, "bold")
    ...
    un_objetivo_radio = Radiobutton(frame1, text="Un objetivo", value=1,
                                    variable=objetivo_var, bg="#FFFFFF", fg="#495057", 
                                    font=("Arial", 10), selectcolor="#DEE2E6")
    ...
    subtitulo2_label1 = Label(frame1, bg="#FFFFFF", fg="#495057", font=("Arial", 12, "bold")
    ...
    subtitulo_label3 = Label(frame1, bg="#FFFFFF", fg="#495057", font=("Arial", 12, "bold")
                            , text="Configuración del Canvas", )
    subtitulo_label3.grid(row=4, column=0, padx=5, sticky="w", columnspan=2, pady=5)

    ## Ancho del Canvas
    conf_anchocanvas_label = Label(frame1, text="Ancho del Canvas:", bg="#FFFFFF", fg="#6C757D", font=("Arial", 10))
    conf_anchocanvas_label.grid(row=5, column=0, padx=5, pady=5, sticky="w")

    conf_anchocanvas_entry = Entry(frame1, font=("Arial", 10), width=5, bg="#F8F9FA", fg="#495057", 
                                  relief="solid", bd=1)
    conf_anchocanvas_entry.grid(row=5, column=1, padx=5, pady=5, sticky="w")
    conf_anchocanvas_entry.insert(0, "500")

    conf_anchocanvas_sub_label = Label(frame1, text="(pixeles)", bg="#FFFFFF", fg="#ADB5BD", font=("Arial", 8))
    conf_anchocanvas_sub_label.grid(row=5, column=2, padx=5, pady=5, sticky="w")

    ## Alto del Canvas
    conf_altocanvas_label = Label(frame1, text="Alto del Canvas:", bg="#FFFFFF", fg="#6C757D", font=("Arial", 10))
    conf_altocanvas_label.grid(row=6, column=0, padx=5, pady=5, sticky="w")

    conf_altocanvas_entry = Entry(frame1, font=("Arial", 10), width=5, bg="#F8F9FA", fg="#495057",
                                 relief="solid", bd=1)
    conf_altocanvas_entry.grid(row=6, column=1, padx=5, pady=5, sticky="w")
    conf_altocanvas_entry.insert(0, "500")

    conf_altocanvas_sub_label = Label(frame1, text="(pixeles)", bg="#FFFFFF", fg="#ADB5BD", font=("Arial", 8))
    conf_altocanvas_sub_label.grid(row=6, column=2, padx=5, pady=5, sticky="w")

    ## Definicion Canvas
    conf_defcanvas_label = Label(frame1, text="Definición del Canvas:", bg="#FFFFFF", fg="#6C757D", font=("Arial", 10))
    conf_defcanvas_label.grid(row=7, column=0, padx=5, pady=5, sticky="w")

    conf_defcanvas_entry = Entry(frame1, font=("Arial", 10), width=5, bg="#F8F9FA", fg="#495057",
                                relief="solid", bd=1)
    conf_defcanvas_entry.grid(row=7, column=1, padx=5, pady=5, sticky="w")
    conf_defcanvas_entry.insert(0, "5")

    conf_defcanvas_sub_label = Label(frame1, text="(Resolución)", bg="#FFFFFF", fg="#ADB5BD", font=("Arial", 8))
    conf_defcanvas_sub_label.grid(row=7, column=2, padx=5, pady=5, sticky="w")

    ## Definicion Colores
    conf_defcolores_label = Label(frame1, text="Definición de Colores:", bg="#FFFFFF", fg="#6C757D", font=("Arial", 10))
    conf_defcolores_label.grid(row=8, column=0, padx=5, pady=5, sticky="w")

    conf_defcolores_entry = Entry(frame1, font=("Arial", 10), width=5, bg="#F8F9FA", fg="#495057",
                                 relief="solid", bd=1)
    conf_defcolores_entry.grid(row=8, column=1, padx=5, pady=5, sticky="w")
    conf_defcolores_entry.insert(0, "100")

    conf_defcolores_sub_label = Label(frame1, text="(Niveles)", bg="#FFFFFF", fg="#ADB5BD", font=("Arial", 8))
    conf_defcolores_sub_label.grid(row=8, column=2, padx=5, pady=5, sticky="w")

    # Configuración 2 frame
    ## Titulo de configuración
    subtitulo_label2 = Label(frame2, bg="#F1F2F6", fg="#343A40", font=("Arial", 12, "bold")
                            , text="Configuración del Algoritmo", )
    subtitulo_label2.grid(row=0, column=0, padx=5, sticky="w", columnspan=2, pady=5)

    ## Número de partículas 
    conf_numparticulas_label = Label(frame2, text="Número de Partículas:", bg="#F1F2F6", fg="#495057", font=("Arial", 10))
    conf_numparticulas_label.grid(row=1, column=0, padx=5, pady=5, sticky="w")

    conf_numparticulas_entry = Entry(frame2, font=("Arial", 10), width=5, bg="#FFFFFF", fg="#495057",
                                    relief="solid", bd=1)
    conf_numparticulas_entry.grid(row=1, column=1, padx=5, pady=5, sticky="w")
    conf_numparticulas_entry.insert(0, "15")

    conf_numparticulas_sub_label = Label(frame2, text="(particulas)", bg="#F1F2F6", fg="#6C757D", font=("Arial", 8))
    conf_numparticulas_sub_label.grid(row=1, column=2, padx=5, pady=5, sticky="w")

    ## Peso de inercia 
    conf_pesoinceria_label = Label(frame2, text="Peso de Inercia (w):", bg="#F1F2F6", fg="#495057", font=("Arial", 10))
    conf_pesoinceria_label.grid(row=2, column=0, padx=5, pady=5, sticky="w")

    conf_pesoinceria_entry = Entry(frame2, font=("Arial", 10), width=5, bg="#FFFFFF", fg="#495057",
                                  relief="solid", bd=1)
    conf_pesoinceria_entry.grid(row=2, column=1, padx=5, pady=5, sticky="w")
    conf_pesoinceria_entry.insert(0, "0.6")

    conf_pesoinceria_sub_label = Label(frame2, text="0.0-1.0", bg="#F1F2F6", fg="#6C757D", font=("Arial", 8))
    conf_pesoinceria_sub_label.grid(row=2, column=2, padx=5, pady=5, sticky="w")

    ## Minimo iteraciones
    conf_miniteraciones_label = Label(frame2, text="Mínimo Iteraciones:", bg="#F1F2F6", fg="#495057", font=("Arial", 10))
    conf_miniteraciones_label.grid(row=3, column=0, padx=5, pady=5, sticky="w")

    conf_miniteraciones_entry = Entry(frame2, font=("Arial", 10), width=5, bg="#FFFFFF", fg="#495057",
                                     relief="solid", bd=1)
    conf_miniteraciones_entry.grid(row=3, column=1, padx=5, pady=5, sticky="w")
    conf_miniteraciones_entry.insert(0, "25")

    conf_miniteraciones_sub_label = Label(frame2, text="(iteraciones)", bg="#F1F2F6", fg="#6C757D", font=("Arial", 8))
    conf_miniteraciones_sub_label.grid(row=3, column=2, padx=5, pady=5, sticky="w")

    ## Pp inicial
    conf_ppinicial_label = Label(frame2, text="Pp Inicial:", bg="#F1F2F6", fg="#495057", font=("Arial", 10))
    conf_ppinicial_label.grid(row=4, column=0, padx=5, pady=5, sticky="w")

    conf_ppinicial_entry = Entry(frame2, font=("Arial", 10), width=5, bg="#FFFFFF", fg="#495057",
                                relief="solid", bd=1)
    conf_ppinicial_entry.grid(row=4, column=1, padx=5, pady=5, sticky="w")
    conf_ppinicial_entry.insert(0, "2.5")

    conf_ppinicial_sub_label = Label(frame2, text="(coeficiente)", bg="#F1F2F6", fg="#6C757D", font=("Arial", 8))
    conf_ppinicial_sub_label.grid(row=4, column=2, padx=5, pady=5, sticky="w")

    ## Pp final
    conf_ppfinal_label = Label(frame2, text="Pp Final:", bg="#F1F2F6", fg="#495057", font=("Arial", 10))
    conf_ppfinal_label.grid(row=5, column=0, padx=5, pady=5, sticky="w")

    conf_ppfinal_entry = Entry(frame2, font=("Arial", 10), width=5, bg="#FFFFFF", fg="#495057",
                              relief="solid", bd=1)
    conf_ppfinal_entry.grid(row=5, column=1, padx=5, pady=5, sticky="w")
    conf_ppfinal_entry.insert(0, "0.5")

    conf_ppfinal_sub_label = Label(frame2, text="(coeficiente)", bg="#F1F2F6", fg="#6C757D", font=("Arial", 8))
    conf_ppfinal_sub_label.grid(row=5, column=2, padx=5, pady=5, sticky="w")

    ## Pg inicial
    conf_pginicial_label = Label(frame2, text="Pg Inicial:", bg="#F1F2F6", fg="#495057", font=("Arial", 10))
    conf_pginicial_label.grid(row=6, column=0, padx=5, pady=5, sticky="w")

    conf_pginicial_entry = Entry(frame2, font=("Arial", 10), width=5, bg="#FFFFFF", fg="#495057",
                                relief="solid", bd=1)
    conf_pginicial_entry.grid(row=6, column=1, padx=5, pady=5, sticky="w")
    conf_pginicial_entry.insert(0, "0.5")

    conf_pginicial_sub_label = Label(frame2, text="(coeficiente)", bg="#F1F2F6", fg="#6C757D", font=("Arial", 8))
    conf_pginicial_sub_label.grid(row=6, column=2, padx=5, pady=5, sticky="w")

    ## Pg final
    conf_pgfinal_label = Label(frame2, text="Pg Final:", bg="#F1F2F6", fg="#495057", font=("Arial", 10))
    conf_pgfinal_label.grid(row=7, column=0, padx=5, pady=5, sticky="w")

    conf_pgfinal_entry = Entry(frame2, font=("Arial", 10), width=5, bg="#FFFFFF", fg="#495057",
                              relief="solid", bd=1)
    conf_pgfinal_entry.grid(row=7, column=1, padx=5, pady=5, sticky="w")
    conf_pgfinal_entry.insert(0, "2.5")

    conf_pgfinal_sub_label = Label(frame2, text="(coeficiente)", bg="#F1F2F6", fg="#6C757D", font=("Arial", 8))
    ...
    conf_manual_checkbox = Checkbutton(frame2, text="Modo Manual", bg="#F1F2F6", fg="#495057", 
                                      font=("Arial", 10), variable=manual_var, selectcolor="#CED4DA")
    ...
    conf_inicio_button = Button(frame2, text="Iniciar Optimización", 
                                ...
                                command=Iniciar_Optimizacion, bg="#495057", fg="#FFFFFF",
                                activebackground="#343A40", activeforeground="#FFFFFF",
                                relief="solid", bd=1)
    ...
    subtitulo_label3 = Label(frame3, bg="#E9ECEF", fg="#343A40", font=("Arial", 12, "bold")
                            , text="Resultados", )
    ...
    resultados_scroll = scrolledtext.ScrolledText(frame3, bg="#FFFFFF", 
                                                ...
                                                fg="#495057", selectbackground="#DEE2E6")
    ...
    boton_borrar = Button(frame3, text="Borrar Resultados", font=("Arial", 10, "bold"), 
                         width=16, height=1, command=Borrar_Resultados,
                         bg="#6C757D", fg="#FFFFFF", activebackground="#495057", 

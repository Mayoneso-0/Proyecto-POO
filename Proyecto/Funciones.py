...
def beale_function(x, y):
    if x < inicio_dom_x or x > final_dom_x or y < inicio_dom_y or y > final_dom_y:
        return 1e10
    resultado = (1.5 - x + x * y) ** 2 + (2.25 - x + x * y ** 2) ** 2 \
         + (2.625 - x + x * y ** 3) ** 2
    return resultado
...
def goldstein_price_function(x, y):
    if x < inicio_dom_x or x > final_dom_x or y < inicio_dom_y or y > final_dom_y:
        return 1e10
    resultado = (1 + ((x + y + 1) ** 2) * (19 - 14 * x + 3 * x ** 2 - 14 * y \
                + 6 * x * y + 3 * y ** 2)) * (30 + ((2 * x - 3 * y) ** 2) * \
...
def griewank_function(x, y):
    if x < inicio_dom_x or x > final_dom_x or y < inicio_dom_y or y > final_dom_y:
        return 1e10
    resultado = 1 + 1/4000 * (x ** 2 + y ** 2) - \
        (math.cos(x) * math.cos(y / 2 ** 0.5))
    return resultado
